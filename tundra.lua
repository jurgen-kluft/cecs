...
Build {
	...
	Units = function ()
		...
		local xecs_library = StaticLibrary {
			Name = "xecs",
			Config = "*-*-*-*",
			Sources = { SourceGlob("source/main/cpp") },
			Includes = { "..//xecs/source/main/include","..//xbase/source/main/include" },
		}
		local unittest = Program {
			Name = "xecs_test",
			Config = "*-*-*-test",
			Sources = { SourceGlob("source/test/cpp") },
			Includes = { "source/main/include","source/test/include","..//xunittest/source/main/include","..//xentry/source/main/include","..//xbase/source/main/include","..//xecs/source/main/include" },
			Depends = { xunittest_library,xentry_library,xbase_library,xecs_library },
		}
		Default(unittest)
	end,
	Configs = {
