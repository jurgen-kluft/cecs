...
namespace xcore
{
    ...
    bool                g_has_tag(ecs2_t* ecs, entity_t entity, tg_type_t const* cp_type)
    {
        return false;
    }

    void                g_set_tag(ecs2_t* ecs, entity_t entity, tg_type_t const* cp_type)
    {
        
    }

    void                g_rem_tag(ecs2_t* ecs, entity_t entity, tg_type_t const* cp_type)
    {
