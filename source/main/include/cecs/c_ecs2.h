...
namespace ncore
{
    namespace necs2
    {
        ...
        extern cp_type_t*  g_register_cp_type(ecs_t* ecs, cp_group_t* cp_group, const char* cp_name, s32 cp_sizeof, s32 cp_alignof = 8);
        extern tg_type_t*  g_register_tg_type(ecs_t* ecs, cp_group_t* cp_group, const char* tg_name);
        ...
        extern void                g_set_tag(ecs_t* ecs, entity_t entity, tg_type_t* tg_type);
        ...
        struct en_iterator_t // 56 bytes
        {
            ...
            void set_tg_type(tg_type_t* cp_type) { set_cp_type((cp_type_t*)cp_type); }
