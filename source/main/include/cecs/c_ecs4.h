...
#define DECLARE_ECS4_TAG(N) \
    ...
    {                       \
        ...
        void g_register_archetype(ecs_t* ecs, u8 archetype_index, u16 components_per_entity = 16, u16 max_global_component_types = 256, u16 tags_per_entity = 8, u16 max_global_tag_types = 32);
        ...
        template <typename T> void g_mark_cp(ecs_t* ecs, u8 archetype_index, u64& cp_occupancy) { g_mark_cp(ecs, archetype_index, T::ECS4_COMPONENT_INDEX, cp_occupancy); }
        template <typename T> void g_mark_tag(ecs_t* ecs, u8 archetype_index, u32& tag_occupancy) { g_mark_tag(ecs, archetype_index, T::ECS4_TAG_INDEX, tag_occupancy); }
        ...
        {
            en_iterator_t(ecs_t* ecs, u8 archetype_index, u64 cp_occupancy, u32 tag_occupancy);
